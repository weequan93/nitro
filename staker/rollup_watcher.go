...
type RollUpLogic struct {
	Erc20RollUpUserLogic *rollupgen.ERC20RollupUserLogic
...
func (r *RollUpLogic) CreateChallenge(opts *bind.TransactOpts, stakers [2]common.Address, nodeNums [2]uint64, machineStatuses [2]uint8, globalStates [2]rollupgen.GlobalState, numBlocks uint64, secondExecutionHash [32]byte, proposedBlocks [2]*big.Int, wasmModuleRoots [2][32]byte) (*types.Transaction, error) {
	if r.Erc20RollUpUserLogic != nil {
...
func (r *RollUpLogic) GetNode(callOpts *bind.CallOpts, nodeNum uint64) (rollupgen.Node, error) {
	if r.Erc20RollUpUserLogic != nil {
...
func (r *RollUpLogic) StakeOnNewNode(opts *bind.TransactOpts, assertion rollupgen.Assertion, expectedNodeHash [32]byte, prevNodeInboxMaxCount *big.Int) (*types.Transaction, error) {
	if r.Erc20RollUpUserLogic != nil {
...
func (r *RollUpLogic) ParseNodeCreated(ethLog types.Log) (uint64, rollupgen.Assertion, *big.Int, [32]byte, [32]byte, [32]byte, [32]byte, error) {
	if r.Erc20RollUpUserLogic != nil {
		parsedLog, err := r.Erc20RollUpUserLogic.ParseNodeCreated(ethLog)
		if err != nil {
			return 0, rollupgen.Assertion{}, nil, [32]byte{}, [32]byte{}, [32]byte{}, [32]byte{}, err
		}
...
func NewRollupWatcher(address common.Address, client RollupWatcherL1Interface, callOpts bind.CallOpts) (*RollupWatcher, error) {
	...
	dummyRollUp, err := rollupgen.NewRollupUserLogic(address, client)
	if err != nil {
		return nil, err
	}
...
func (r *RollupWatcher) Erc20LookupCreation(ctx context.Context) (*rollupgen.ERC20RollupUserLogicRollupInitialized, error) {
	var query = ethereum.FilterQuery{
		FromBlock: r.fromBlock,
		ToBlock:   r.fromBlock,
		Addresses: []common.Address{r.address},
...
func (r *RollupWatcher) LookupNode(ctx context.Context, number uint64) (*NodeInfo, error) {
	...
	return &NodeInfo{
		...
		Assertion:                NewAssertionFromSolidity(assertion),
