...
func (_IERC20 *IERC20Transactor) Withdraw(opts *bind.TransactOpts, amount *big.Int) (*types.Transaction, error) {
	return _IERC20.contract.Transact(opts, "withdraw", amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 amount) returns()
func (_IERC20 *IERC20Session) Withdraw(amount *big.Int) (*types.Transaction, error) {
	return _IERC20.Contract.Withdraw(&_IERC20.TransactOpts, amount)
}

// Withdraw is a paid mutator transaction binding the contract method 0x2e1a7d4d.
//
// Solidity: function withdraw(uint256 amount) returns()
func (_IERC20 *IERC20TransactorSession) Withdraw(amount *big.Int) (*types.Transaction, error) {
	return _IERC20.Contract.Withdraw(&_IERC20.TransactOpts, amount)
}
...
func (_IERC20 *IERC20Transactor) WithdrawToken(opts *bind.TransactOpts, token common.Address, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IERC20.contract.Transact(opts, "withdrawToken", token, account, amount)
}

// WithdrawToken is a paid mutator transaction binding the contract method 0x01e33667.
//
// Solidity: function withdrawToken(address token, address account, uint256 amount) returns()
func (_IERC20 *IERC20Session) WithdrawToken(token common.Address, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IERC20.Contract.WithdrawToken(&_IERC20.TransactOpts, token, account, amount)
}

// WithdrawToken is a paid mutator transaction binding the contract method 0x01e33667.
//
// Solidity: function withdrawToken(address token, address account, uint256 amount) returns()
func (_IERC20 *IERC20TransactorSession) WithdrawToken(token common.Address, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IERC20.Contract.WithdrawToken(&_IERC20.TransactOpts, token, account, amount)
}
