...
func checkIfRectifyMappingWorks(t *testing.T, aset *AddressMap, owners []common.Address, clearList bool) {
	t.Helper()
	if clearList {
...
func checkAllMembers(t *testing.T, aset *AddressMap, possibleAddresses []common.Address) {
...
func isMember(t *testing.T, aset *AddressMap, address common.Address) bool {
	t.Helper()
...
func size(t *testing.T, aset *AddressMap) uint64 {
	t.Helper()
	size, err := aset.Size()
	Require(t, err)
	return size
