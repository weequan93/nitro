...
func createNodeImpl(
	...
	if config.Staker.Enable {
		...
		tmpAddress := common.HexToAddress(config.Staker.StakeAmountAddress)
		stakerObj, err = staker.NewStaker(l1Reader, wallet, bind.CallOpts{}, func() *staker.L1ValidatorConfig { return &configFetcher.Get().Staker }, blockValidator, statelessBlockValidator, nil, confirmedNotifiers, deployInfo.ValidatorUtils, fatalErrChan, &tmpAddress)
